...
cleaned_file = "D:/python-project/课后作业/output/construction_hazard_rectification_cleaned.csv"
report_file = "D:/python-project/课后作业/output/construction_hazard_rectification_report.txt"
...
for raw_record in raw_record_list:
    ...
    if rectification_status == "未整改":
        ...
        elif review_result == "通过" and overdue_days <= 7:
