...
for line in lines:
    ...
    # TODO：
    # 如果 clean_line 不是空字符串
    # 并且 clean_line 不是 "客户名称,手机号,金额"--> 标题行
    # 就 append 到 raw_record_list
...
for record in raw_record_list:
    ...
    # TODO：
    # 判断 customer 是否为空
    # 判断 amount_text 是否为数字
    # 金额支持整数和小数，所以用：
    # amount_text.replace(".", "", 1).isdigit()
