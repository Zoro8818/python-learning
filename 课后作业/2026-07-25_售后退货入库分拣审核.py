...
cleaned_file = "D:/python-project/课后作业/output/after_sales_return_sorting_cleaned.csv"
report_file = "D:/python-project/课后作业/output/after_sales_return_sorting_report.txt"
