...
cleaned_file = "D:/python-project/课后作业/output/equipment_maintenance_cycle_review_cleaned.csv"
report_file = "D:/python-project/课后作业/output/equipment_maintenance_cycle_review_report.txt"
